...
![Docker Desktop - Containers corriendo](docs/images/docker-desktop.png)
...
![Portal Principal](docs/images/portal.png)

### Orquestador (`http://localhost:3003/orchestrator`)

![Orquestador](docs/images/orchestrator.png)
...
### Consola Interactiva (`http://localhost:3003/orchestrator/console`)

![Consola Interactiva](docs/images/console.png)
...
El proyecto está integrado con [SonarCloud](https://sonarcloud.io/project/overview?id=neuroneter_Jelou-TechnicalTest) para análisis estático de código.

![SonarCloud - Análisis de calidad](docs/images/sonar.png)
...
El informe completo de SonarCloud se encuentra en [`docs/SonarInforme.pdf`](docs/SonarInforme.pdf).
